            ...
            Input => {
                ...
                match pin {
                    G0 => {
                        ...
                        let handle = Peripherals::take()
                            .unwrap()
                            .GPIO_PORTA
                            .split(&sys_init().power_control)
                            .pa0
                            .into_pull_up_input();
