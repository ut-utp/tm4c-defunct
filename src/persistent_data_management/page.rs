...
pub trait Paging{
    ...
    fn read_swap(&mut self, addr: Self::device_addr) -> Result<Self::device_word, SwapError>;
    fn write_swap(&mut self, addr: Self::device_addr, data: Self::device_word) -> Result<Word, SwapError>;
    fn read_primary(&mut self, addr: Self::device_addr) -> Result<(), SwapError>;
    fn write_primary(&mut self, data: Self::device_word) -> Result<(), SwapError>;
