...
fn main() -> ! {
 	    ...
 	    let mut pwm0 = p.PWM0;
 	    let mut pwm1 = p.PWM1;
 	    let mut pwm_shim = pwm::PwmShim::new(required_components{sysctl:sc, portb:portb, pwm0:pwm0, pwm1:pwm1 });
 	    pwm_shim.set_state(PwmPin::P0, PwmState::Enabled(core::num::NonZeroU8::new(150).unwrap()));
